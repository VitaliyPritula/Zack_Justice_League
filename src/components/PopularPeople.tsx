...
export const PopularPeople = () => {
  return (
    <div className="text-white mx-auto overflow-hidden 2xl:px-20 px-4 pt-[70px] pb-[60px]">
      ...
      <div className="flex overflow-x-auto scroll-smooth gap-6 scrollbar-hidden snap-x snap-mandatory px-4">
        {popularPeople.map((item) => (
          <Link to={item.url} key={item.id} className="text-center ">
            <img
              src={item.image}
              alt={item.name}
